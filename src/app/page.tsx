...
export default function HomePage() {
  return <>
    <main>
      <section className="hero" aria-labelledby="hero-title"><div className="container hero__grid"><div className="hero__copy"><p className="eyebrow">Guía editorial de energía portátil</p><h1 id="hero-title">Energía para viajar a tu manera.</h1><p className="hero__lead">Te ayudamos a entender y comparar power stations para camping, camper, caravanas y vida off-grid según lo que realmente necesitas alimentar.</p><div className="button-row"><Link className="button button--primary" href="/encontrar-power-station">Encuentra la tuya <span aria-hidden="true">→</span></Link><Link className="button button--quiet" href="/guias">Aprende cómo funcionan</Link></div></div><div className="hero__visual" aria-hidden="true"><div className="energy-orbit energy-orbit--outer" /><div className="energy-orbit energy-orbit--inner" /><div className="energy-core"><span>Wh</span><small>para tu viaje</small></div><div className="energy-note energy-note--solar">Solar<br /><strong>recarga</strong></div><div className="energy-note energy-note--power">W<br /><strong>potencia</strong></div></div></div></section>
